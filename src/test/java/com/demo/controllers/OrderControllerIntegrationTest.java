...
public class OrderControllerIntegrationTest {
    ...
    public void shouldGetOrdersBetweenDates() throws Exception {
        ...
        List<Order> afterEarliestDateOrders = Collections.singletonList(mapper.readValue(afterEarlyDateOrdersResult.getResponse().getContentAsString(), new TypeReference<Order>() {
        }));
        ...
        List<Order> beforeEarliestDateOrders = Collections.singletonList(mapper.readValue(beforeEarlyDateOrdersResult.getResponse().getContentAsString(), new TypeReference<Order>() {
        }));
    ...
    public void shouldCreateOrderFromMinimalJSONAndReturnPopulatedOrderData() throws Exception {
        ...
        Assert.assertThat(retrievedOrder.get().getTotalAmount(), amountMatcher(savedPrice1.getAmount()));
