...
public class ProductControllerIntegrationTest {
    ...
    public void shouldReturnExistingProducts() throws Exception {
        ...
        List<Product> newProduct = Collections.singletonList(mapper.readValue(contentAsString, new TypeReference<Product>() {
        }));
    ...
    public void shouldBeAbleToUpdateCurrentPriceWithoutChangingExistingOrdersAmounts() throws Exception {
        ...
        Price initialPrice = initialProductWithPrice.getCurrentPrice().get();
        ...
        BigDecimal prePriceChangeAmount = orderRepository.findById(savedOrder.getId()).get().getTotalAmount();
        ...
        Assert.assertEquals(prePriceChangeAmount, orderRepository.findById(order.getId()).get().getTotalAmount());
